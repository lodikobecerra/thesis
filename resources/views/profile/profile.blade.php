                ...
                <div class="card author-box">
                  <div class="card-body">
                    <div class="author-box-center">
                      <img alt="image" src="assets/img/users/3.jpg" class="rounded-circle author-box-picture">
                      <div class="clearfix"></div>
                      <div class="author-box-name">
                        <a href="#">Rick Earljohn Mariano Jumuad</a>
                      </div>
                      <div class="author-box-job">Engineer</div>
                    </div>
              ...
              <div class="col-12 col-md-12 col-lg-8">
                <div class="card">
                  <div class="padding-20">
                    <ul class="nav nav-tabs" id="myTab2" role="tablist"style="background-color: #e2e6ea;">
                      <li class="nav-item">
                      ...
                      <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                        <div class="row">
                          <div class="col-md-3 col-6 b-r">
                            ...
                            <br>
                            <p class="text-muted">Rick Earljohn Mariano Jumuad</p>
                          </div>
                          <div class="col-md-3 col-6 b-r">
