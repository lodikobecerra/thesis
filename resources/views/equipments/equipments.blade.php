								...
								<div class="" id="myTab3" role="tablist">
									<div class="row">
									  <div class="col-xs-12 ml-1 mb-2">
										<a class=" btn btn-primary btn-rounded" href="equipments">All Equipments</a>
									  </div>
									  <div class=" col-xs-12 ml-1 mb-2">
                                      ...
                                      <div class="dropdown d-inline ml-auto">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                                          ...
                                          <a class="dropdown-item" href="batching">Batching</a>
								...
								<div class="tab-pane fade show active" id="trucks" role="tabpanel" aria-labelledby="trucks-tab">
										...
										<div class="card">
											<div class="card-header">
												<h4>L.R.Tiqui Heavy Equipments</h4>
											</div>
				...
				<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-header" style="background-color:#e2e6ea;">
                            <h5 class="modal-title" id="myLargeModalLabel">Add Equipment</h5>
