							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="" id="myTab3" role="tablist">
									<div class="row">
									  ...
									  <div class=" col-xs-12 ml-1 mb-2">
										<a class="btn btn-primary btn-rounded " href="elfs">Elfs</a>
									  </div>
									  <div class=" col-xs-12 ml-1 mb-2">
											...
											<div class="card-body p-0">
												<div class="table-responsive">
													<table class="table table-hover table-striped table-vcenter mb-0 text-nowrap">
														...
														<tbody>
															@foreach($equipments as $elf)
															<tr>
																<td><h5><span class="badge badge-secondary">{{$elf->body_number}}</span></h5></td></span>
																<td><span>{{$elf->status}}</span></td>
																<td><span>{{$elf->last_location}}</span></td>
																<td><span>{{$elf->operator}}</span></td>
