											...
											<div class="card-body p-0">
												<div class="table-responsive">
													<table class="table table-hover table-striped table-vcenter mb-0 text-nowrap">
														...
														<tbody>
															@foreach($equipments as $batching)
															<tr>
																<td><h5><span class="badge badge-secondary">{{$batching->body_number}}</span></h5></td></span>
																<td><span>{{$batching->status}}</span></td>
																<td><span>{{$batching->last_location}}</span></td>
																<td><span>{{$batching->operator}}</span></td>
