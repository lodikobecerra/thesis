						...
						<div class="row clearfix">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<ul class="nav nav-pills" id="myTab3" role="tablist">
				                    ...
				                    <li class="nav-item">
				                      <a class="nav-link active" href="backhoeLoaders">Backhoe Loaders</a>
				                    </li>
				                    <li class="nav-item">
											...
											<div class="card-body p-0">
												<div class="table-responsive">
													<table class="table table-hover table-striped table-vcenter mb-0 text-nowrap">
														...
														<tbody>
															@foreach($equipments as $backhoe)
															<tr>
																<td><h5><span class="badge badge-secondary">{{$backhoe->body_number}}</span></h5></td></span>
																<td><span>{{$backhoe->status}}</span></td>
																<td><span>{{$backhoe->last_location}}</span></td>
																<td><span>{{$backhoe->operator}}</span></td>
